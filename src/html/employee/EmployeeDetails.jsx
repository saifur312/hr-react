          ...
          <Col md={12}>
            ...
            >
              <tbody>
                ...
                <tr>
                  <th>AppliacationDate: </th>{' '}
                  <td> {employeeData.appliacationDate}</td>
                  <th>InterviewDate: </th>{' '}
                  <td> {employeeData.interviewDate}</td>
                  <th>ConfirmDate: </th> <td> {employeeData.confirmDate}</td>
                </tr>
                <tr>
                  <th>JoinDate: </th> <td> {employeeData.joinDate}</td>
                  <th>IncrementDate: </th>{' '}
                  <td> {employeeData.incrementDate}</td>
                  <th>PromotionDate: </th>{' '}
                  <td> {employeeData.promotionDate}</td>
                </tr>
                <tr>
                  <th>RetiermentDate: </th>{' '}
                  <td> {employeeData.retiermentDate}</td>
                  <th>PfID: </th> <td> {employeeData.pfID}</td>
                  <th>PfJoinDate: </th> <td> {employeeData.pfJoinDate}</td>
                </tr>
                <tr>
                  <th>FinalSettleDate: </th>{' '}
                  <td> {employeeData.finalSettleDate}</td>
                  <th>Nationality: </th> <td> {employeeData.nationality}</td>
                  <th>EmergencyContact: </th>{' '}
                  <td> {employeeData.emergencyContact}</td>
                </tr>
                <tr>
