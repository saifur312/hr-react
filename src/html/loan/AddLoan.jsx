            ...
            <Col md={10}>
                ...
                >
                    <div className="row" >
                        ...
                        <div className="form-group row col-lg-12 mt-4">
                            <label htmlFor="deductionAmount" className="col-form-label col-lg-4">
                        ...
                        <div className="form-group row col-lg-12 mt-4">
                            <label htmlFor="transactionDateStr" className="col-form-label col-lg-4">
                        ...
                        <div className="form-group row col-lg-12 mt-4">
                            <label htmlFor="loanEndDateStr" className="col-form-label col-lg-4">
                        ...
                        <div className="form-group row col-lg-12 mt-4">
                            <label htmlFor="deductionType" className="col-form-label col-lg-4">
