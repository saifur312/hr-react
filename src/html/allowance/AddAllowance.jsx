...
function AddAllowance() {
  ...
  return (
    <Row className="justify-content-md-center m-4">
      <h2 className="content-title">Add Employee's Allowance</h2>
      <Col md={10}>
        <Form onSubmit={handleSubmit} action="" method="POST" className="form">
          <div className="row">
            ...
            <Form.Group className="row">
              <Form.Label className="col-form-label col-lg-4">
                Employee ID:{' '}
              </Form.Label>
              <Typeahead
                className="col-lg-6"
            ...
            <div className="form-group row col-lg-12 mt-4">
              ...
              <div className="col-lg-6">
                <input
                  ...
                  onChange={(event) =>
                    setAttendanceAllowance(event.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="form-group row col-lg-12 mt-4">
              ...
              <div className="col-lg-6">
                <input
                  ...
                  onChange={(event) =>
                    setNonPracticeAllowance(event.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="form-group row col-lg-12 mt-4">
              ...
              <div className="col-lg-6">
                <input
                  ...
                  onChange={(event) =>
                    setTransportAllowance(event.target.value)
                  }
                />
              </div>
            </div>
