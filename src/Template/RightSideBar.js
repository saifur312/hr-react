        ...
        <aside className="sidebar-right">
            <nav>
                <ul>
                    ...
                    <li> <Link to="/Section List">Section List </Link> </li>
                    <li> <Link to="/Add Bank info">Add Bank info</Link> </li>
                    <li> <Link to="/Bank info List">Bank info List </Link> </li>
                    <li> <Link to="/Add Overtime">Add Overtime</Link> </li>
                    <li> <Link to="/Overtime List">Overtime List </Link> </li>
                    ...
                    <li> <Link to="/Add Deduction">Add Deduction </Link> </li>
